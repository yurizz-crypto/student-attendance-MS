<div class="space-y-8" x-data="dashboardCharts({
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route('admin.backup-settings') }}" class="flex items-center gap-3 p-4 bg-success/5 rounded-lg border border-success/10 hover:bg-success/10 transition-colors group">
